...
const MenuNavigationGroup = () => {
  return (
    <nav className="pt-8 md:pt-12 px-4">
      <h3 className="text-xl md:text-2xl font-semibold mb-2">Products:</h3>
      <ul className="ml-2 pl-2 border-l-gray-200 border-l-2">
        <MenuSideDrawerItem category={'all'} href={'/products'} />
        <MenuSideDrawerItem category={'chairs'} href={'/products/chairs'} />
        <MenuSideDrawerItem category={'storage'} href={'/products/storage'} />
        <MenuSideDrawerItem category={'beds'} href={'/products/beds'} />
        <MenuSideDrawerItem category={'sofas'} href={'/products/sofas'} />
        <MenuSideDrawerItem category={'tables'} href={'/products/tables'} />
      </ul>
    </nav>
  );
};
